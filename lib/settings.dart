...
class Settings extends StatelessWidget {
  ...
  Settings(GoogleSignIn _googleAccount, FirebaseUser _firebaseAccount) {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text("User Settings")),
      drawer: new Drawer(
        child: new ListView(
          children: <Widget>[
              ...
              decoration: new BoxDecoration(
                  image: new DecorationImage(
                      ...
                      image: new NetworkImage(
                          "https://www.pixelstalk.net/wp-content/uploads/wallpapers/Color-Chromebook-Wallpaper-HD-4.png")
                  )
              ),
            ),
            new ListTile(
              ...
              enabled: true,
              onTap: () {
                Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => new Driverdash(googleAccount, firebaseAccount)));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              enabled: true,
              onTap: () {
                Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => new TravelHistory(googleAccount, firebaseAccount)));
              },
            ),
            new Divider(),
            new ListTile(
